...
public interface Recommender extends Refreshable {
     ...
     * @throws TasteException
     */
    long[] recommendUser(long userID, int howMany) throws TasteException;

    List<MyRec> recommendSong(long[] theNeighborhood, long userID, int howMany) throws TasteException;
